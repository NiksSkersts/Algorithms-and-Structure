...
namespace IV
{
    ...
    {
        private static readonly MyList list = new();
        ...
        internal class MyList
        {
            ...
            public void Add(Pietura pietura)
            {
                ...
                var current = _first;
                while (current._nextItem != null) current = current._nextItem;
            ...
            public void Insert(Pietura pietura, int index)
            {
                ...
                if (current != null) current._nextItem = it;
                SortList();
            }
